# ![LOGO](logo.png) Amazon Cognito Identity MSP Connector

## Description

A generated MSP connector for the Amazon Cognito Identity API (version 2014-06-30).
...
flowground :- Telekom iPaaS / amazonaws-com-cognito-identity-connector<br/>
