# ![LOGO](logo.png) Amazon Cognito Identity **flow**ground Connector

## Description

A generated **flow**ground connector for the Amazon Cognito Identity API (version 2014-06-30).

Generated from: https://api.apis.guru/v2/specs/amazonaws.com/cognito-identity/2014-06-30/swagger.json<br/>
...
**flow**ground :- Telekom iPaaS / amazonaws-com-cognito-identity-connector<br/>
